  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.text}>
        Welcome to EggPal, a companion web application for Palworlds that helps
        users track breeding combinations and save their pals and combinations.
        By using our service, you agree to these Terms of Service.
      </p>

      <h2 className={styles.subheading}>Acceptance of Terms</h2>
      <p className={styles.text}>
        By accessing or using EggPal, you agree to be bound by these ToS. If you
        do not agree to these ToS, please do not use our service.
      </p>

      <h2 className={styles.subheading}>Changes to Terms</h2>
      <p className={styles.text}>
        We reserve the right to modify these ToS at any time. We will notify you
        of any significant changes by posting the new ToS on our website. Your
      ...
      <p className={styles.text}>
        ...
        that could harm others. This includes, but is not limited to,
      ...
      <p className={styles.text}>
        All content on EggPal, including text, graphics, logos, and software, is
        the property of EggPal or its licensors and is protected by copyright
        and trademark laws. However, EggPal contains images and content from the
        game Palworlds, which are the property of Pocketpair, Inc. EggPal is not
        affiliated with or endorsed by Pocketpair, Inc. All rights to the game
        and related materials are owned by Pocketpair, Inc.
      </p>
      ...
      <p className={styles.text}>
        ...
        of or in connection with the use of our service.
      </p>
